...
Startup_Code/%.o: ../Startup_Code/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16 -g3 -O0 -ffunction-sections -fdata-sections -x assembler-with-cpp -DDEBUG_BUILD -I"C:/Users/Michael/workspace.kds/TIMER_FLEX0/Project_Headers" -Wall -Wextra -c -fmessage-length=0  -o "$@" $<
	@echo 'Finished building: $<'
	@echo ' '
