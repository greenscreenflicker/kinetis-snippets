...
*/
	...
	monitorvars[fill].type=MCU_TRACER_DATA_TYPE_FLOAT;
	monitorvars[fill].rw=0;
	monitorvars[fill].data_f=&pwm_duty_cycle;
	strcpy(monitorvars[fill].varname,"CReg: DutyCy");
	monitorvars[fill].data_fmin=0.0f;
	monitorvars[fill].data_fmax=0.0f;
	fill++;

	monitorvars[fill].type=MCU_TRACER_DATA_TYPE_FLOAT;
	monitorvars[fill].rw=1;
	monitorvars[fill].data_f=&regulator_current_ki;
	strcpy(monitorvars[fill].varname,"CReg: Integrator");
	monitorvars[fill].data_fmin=0.0f;
	monitorvars[fill].data_fmax=0.0f;
	fill++;
	...
	monitorvars[fill].type=MCU_TRACER_DATA_TYPE_FLOAT;
	monitorvars[fill].rw=0;
	monitorvars[fill].data_f=&Ki_factor;
	strcpy(monitorvars[fill].varname,"CReg: Ki");
	monitorvars[fill].data_fmin=0.0f;
	monitorvars[fill].data_fmax=200.0f;
	fill++;
